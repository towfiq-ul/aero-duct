...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="services" className="bg-slate-50/80 border-y border-slate-200/80 py-24">
      ...
      {/* ── Testimonials ── */}
      <section id="reviews" className="bg-slate-50/80 border-y border-slate-200/80 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-600 bg-white border border-slate-200 px-4 py-1.5 rounded-full shadow-sm">
